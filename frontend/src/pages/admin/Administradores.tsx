...
export default function Administradores() {
  ...
  const openEdit = (a: AdminResponse) => {
    setEditTarget(a)
    setForm({ nombre: a.nombre, apellidoPaterno: a.apellidoPaterno, apellidoMaterno: a.apellidoMaterno ?? '', email: a.email ?? '', numEmpleado: a.numEmpleado, fechaNacimiento: a.fechaNacimiento ?? '' })
    setFormError('')
    setModalOpen(true)
  }
