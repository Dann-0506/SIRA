...
const FORMATOS: Record<string, FormatoTipo> = {
  alumnos: {
    ...
    columnas: [
      ...
      { nombre: 'fecha_nacimiento',   requerida: false, descripcion: 'Fecha de nacimiento en formato YYYY-MM-DD (ej. 2003-05-14)' },
    ],
    ejemplo: '21310001,Pérez,García,Juan,juan@escuela.edu,,',
    notas: 'La contraseña temporal será el número de control. Los campos curp y fecha_nacimiento son opcionales — dejar vacíos si no se tienen.',
  },
  maestros: {
    label: 'Maestros',
    columnas: [
    ...
    ejemplo: 'EMP-001,López,Ruiz,María,maria@escuela.edu',
  ...
  administradores: {
    ...
    ejemplo: 'ADMIN-002,Ramírez,,Carlos,carlos@escuela.edu',
    notas: 'La contraseña temporal será el número de empleado.',
  },
  materias: {
    label: 'Materias',
